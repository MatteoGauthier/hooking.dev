...
const NewHook = () => {
  ...
  // const [instruValue] = useDebounce(instru, 1000)
    ...
    <>
      <div className="max-w-4xl p-5 mx-auto mt-16 font-display">
        ...
        <p className="text-gray-700">
          ...
          creating a new branch, a commit and a pull requests. With this
          generator you just have to fill the information of the hook you wanted
          to add, and click on the{" "}
              ...
              <label className="block w-full">
                ...
                <input
                  ...
                  ref={register({
                    ...
                    maxLength: {
                      value: 80,
                      message: `The maximum length is 80`,
                    },
                  })}
              ...
              <label className="block w-full">
                ...
                <input
                  ...
                  ref={register({
                    ...
                    minLength: {
                      value: 20,
                      message: "The minimum length is 20",
                    },
                    maxLength: {
                      value: 70,
                      message: "The maximum length is 70",
                    },
                  })}
                  className="block w-full mt-1 form-input"
